 ...
 * @author Pencerval
 */
@ManagedBean(name = "exerciseDiscriminationControllerPlus")
@SessionScoped
public class ExerciseDiscriminationControllerPlus {
    ...
    private Stimulus stimulusSound1 = null;
    private Stimulus stimulusSound2 = null;
    private Stimulus stimulusImage1 = null;
    private Stimulus stimulusImage2 = null;
    private boolean iguales=true;
    

    public ExerciseDiscriminationControllerPlus() {
    }
    ...
    public void preEdit(Exercise exercise) {
        if (exercise != null) {
            ...
            stimulusSound1 = exercise.getExerciseStimulusMapList().get(0).getStimulus();
            stimulusSound2 = exercise.getExerciseStimulusMapList().get(1).getStimulus();
            stimulusImage1 = exercise.getExerciseStimulusMapList().get(2).getStimulus();
            stimulusImage2 = exercise.getExerciseStimulusMapList().get(3).getStimulus();
    ...
    public List<Exercise> getExerciseList() {
        exerciseList = exerciseFacade.findAllByType(1);
        return exerciseList;
    }
    ...
    public Stimulus getStimulusSound1() {
        return stimulusSound1;
    }

    public void setStimulusSound1(Stimulus stimulus1) {
        this.stimulusSound1 = stimulus1;
    }

    public Stimulus getStimulusSound2() {
        return stimulusSound2;
    }

    public void setStimulusSound2(Stimulus stimulus2) {
        this.stimulusSound2 = stimulus2;
    }
    ...
    public void save() {
        if(getStimulusSound1()==null || getStimulusSound2()==null){
            FacesMessage msg = new FacesMessage(FacesMessage.SEVERITY_ERROR,"Error", "Debe indicar 2 estimulos sonoros.");
            ...
            if(exercise.getName()==null || exercise.getName().isEmpty()){
                exercise.setName(getStimulusSound1().getName()+"-"+getStimulusSound2().getName()+"-"+(isIguales()?"Iguales":"Diferentes"));
            }
            exercise.setType(1);
            ...
            exerciseStimulusMap1.setStimulus(getStimulusSound1());
            ExerciseStimulusMap exerciseStimulusMap2=new ExerciseStimulusMap();
            exerciseStimulusMap2.setExercise(exercise);
            exerciseStimulusMap2.setStimulus(getStimulusSound2());
            ExerciseStimulusMap exerciseStimulusMap3=new ExerciseStimulusMap();
            exerciseStimulusMap3.setExercise(exercise);
            exerciseStimulusMap3.setStimulus(getStimulusImage1());
            ExerciseStimulusMap exerciseStimulusMap4=new ExerciseStimulusMap();
            exerciseStimulusMap4.setExercise(exercise);
            exerciseStimulusMap4.setStimulus(getStimulusImage2());
            ...
            exerciseStimulusMaps.add(exerciseStimulusMap4);
            ...
            exerciseStimulusMapFacade.create(exerciseStimulusMap4);
    ...
    public void back(){
        try {
            FacesContext.getCurrentInstance().getExternalContext().redirect(FacesContext.getCurrentInstance().getExternalContext().getRequestContextPath() + "/admin/exerciseDiscrimination/ListPlus.xhtml");
