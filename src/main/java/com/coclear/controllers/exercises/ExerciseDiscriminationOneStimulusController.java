...
@ManagedBean(name = "playExerciseDiscriminationOneStimulusController")
@ViewScoped
public class ExerciseDiscriminationOneStimulusController implements Serializable {
    ...
    private Stimulus currentStimulusSound;
    ...
    public void init() {
        ...
        setCurrentStimulusSound(exercises.get(0).getExerciseStimulusMapList().get(0).getStimulus());
        setCurrentStimulusImage1(exercises.get(0).getExerciseStimulusMapList().get(1).getStimulus());
        setCurrentStimulusImage2(exercises.get(0).getExerciseStimulusMapList().get(2).getStimulus());

    }

    public ExerciseDiscriminationOneStimulusController() {
    }
    ...
    public Stimulus getCurrentStimulusSound() {
        if (currentStimulusSound == null) {
            init();
        }
        return currentStimulusSound;
    }

    public void setCurrentStimulusSound(Stimulus currentStimulusSound1) {
        this.currentStimulusSound = currentStimulusSound1;
    }
    ...
    public void setSelectedIdStimulus(int selectedIdAnswers) {
        if(isPlayed()){
            ...
            Answer answer;
            if(getSelectedIdStimulus()==currentExercise.getExerciseStimulusMapList().get(1).getStimulus().getIdStimulus()){
            ...
            for (PossibleSolution possibleSolution : currentExercise.getPossibleSolutionList()) {
                if (possibleSolution.getCorrect()){
                    if(possibleSolution.getAnswer().getIdAnswer() == answerFacade.getSameAnswer().getIdAnswer() && getSelectedIdStimulus() == currentExercise.getExerciseStimulusMapList().get(1).getStimulus().getIdStimulus() || possibleSolution.getAnswer().getIdAnswer() == answerFacade.getDifferentAnswer().getIdAnswer() && getSelectedIdStimulus() == currentExercise.getExerciseStimulusMapList().get(2).getStimulus().getIdStimulus()){
    ...
    public String doNext() {
        ...
        if (exercises.size() > position + 1) {
            ...
            setCurrentStimulusSound(exercises.get(position).getExerciseStimulusMapList().get(0).getStimulus());
            setCurrentStimulusImage1(exercises.get(position).getExerciseStimulusMapList().get(1).getStimulus());
            setCurrentStimulusImage2(exercises.get(position).getExerciseStimulusMapList().get(2).getStimulus());
