...
import com.stimulusbriefing.sessionbeans.TaskFacade;
...
public class TaskController implements Serializable {
    ...
    @EJB
    private com.stimulusbriefing.sessionbeans.TaskFacade ejbFacade;
    ...
    public static class TaskControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Task) {
                ...
                throw new IllegalArgumentException("object " + object + " is of type " + object.getClass().getName() + "; expected type: " + TaskController.class.getName());
            }
        }
    }
}
