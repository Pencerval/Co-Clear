...
public class AnswersController implements Serializable {
    ...
    @EJB
    private com.stimulusbriefing.sessionbeans.AnswerGroupFacade ejbFacadeAnswerGroup;
    @EJB
    private com.stimulusbriefing.sessionbeans.AnswerFacade ejbFacadeAnswer;
