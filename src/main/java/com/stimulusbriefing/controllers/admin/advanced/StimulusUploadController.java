...
public class StimulusUploadController implements Serializable {
    ...
    @EJB
    private com.stimulusbriefing.sessionbeans.StimulusGroupFacade ejbFacadeStimulusGroup;
    @EJB
    private com.stimulusbriefing.sessionbeans.StimulusFacade ejbFacadeStimulus;
