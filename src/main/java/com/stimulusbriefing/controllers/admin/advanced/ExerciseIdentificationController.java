...
public class ExerciseIdentificationController implements Serializable {
    ...
    @EJB
    private com.stimulusbriefing.sessionbeans.ExcersiceFacade ejbExercise;
    @EJB
    private com.stimulusbriefing.sessionbeans.StimulusGroupFacade ejbStimulusGroup;
    @EJB
    private com.stimulusbriefing.sessionbeans.StimulusFacade ejbStimulus;
    @EJB
    private com.stimulusbriefing.sessionbeans.AnswerFacade ejbAnswers;
    @EJB
    private com.stimulusbriefing.sessionbeans.ExerciseStimulusMapFacade ejbExerciseStimulusMap;
    @EJB
    private com.stimulusbriefing.sessionbeans.PossibleSolutionFacade ejbPosiPossibleSolutionFacade;
